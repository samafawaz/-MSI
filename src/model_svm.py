...
class SVMClassifier:
    """
    Clean SVM Classifier that works with split and augmented data
    """
    ...
    def train(self, train_dir="data/split/train", test_dir="data/split/test"):
        """
        Train SVM on split data
        
        Args:
            train_dir: Training data directory (augmented)
            test_dir: Test data directory (original)
        """
        print(" TRAINING SVM ON SPLIT DATA")
        print("=" * 40)
